# Panchakarla Sri Venkata Ganesh Naidu
**Lead SRE**
+1(669)-258-9089 | panchakarlaganesh@gmail.com
...
- Confer with users to conduct computer diagnostics to investigate and resolve problems and to provide technical assistance and support.
- Debugged Object-Oriented Java code and analyzed TCP/IP networking logs via Splunk to provide 24/7 support for retail applications.

**Software Developer** | Walgreens, India | May 2014 – Aug 2014
- Analyzed, Designed, Developed and Tested Alfresco application for migrating the content which is available in Stellent using the File System Transfer Receiver (FSTR) API. Developed a custom website to view the migrated documents.

**Software Developer** | UKPN, London | Feb 2014 – Apr 2014
- Worked on upgrade tasks for Alfresco application, customizing Workflow in JBPM and building Java scripts for getting weekly report from Alfresco.
- Creating custom web scripts, which aided in populating the web content and developing websites (external).

**Software Developer** | UKPN, India | July 2011 – Jan 2014
- Upgraded Alfresco applications and customized workflows in JBPM using Java.
- Built JavaScript-based web scripts to automate weekly reporting and populate web content.
- Created a custom content model for Document Management System in Alfresco.
- Designed and developed a web-based Struts application for migrating documents from Stellent and Documentum to Alfresco using built in RESTFul APIs which saved 100K.
- Customized the Alfresco functionalities such as creating custom properties. Additionally, I have gained significant hands-on experience in testing, validating the content migration and monitoring the health of the Alfresco application.
- Developed dynamic HTML components using AJAX, JavaScript (DOM), and CSS, ensuring seamless front-end to back-end integration for internal web applications.

### EDUCATION
**Bachelors in Electrical and Electronics** | Andhra University, India | 2007-2011
- Programming with C, Data Structures, Operating Systems, Object Oriented Language Systems. CGPA - 7.5

### TECHNICAL SKILLS
- **Languages & Scripts:** Java, JavaScript, Bash, Python, SQL.
- **Databases:** PostgreSQL, SQL, MongoDB.
- **Tools:** ServiceNow, AI-Powered tools, Web Services, Grafana, Open Telemetry, Splunk, AWS, Kubernetes, Alfresco, AEM.
